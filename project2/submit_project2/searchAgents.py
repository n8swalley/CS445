...
def cornersHeuristic(state, problem):
    ...
    # start from current position and calculate manhattan distacne to corners
    currentPos = state[0]
    ...
    while remainingCorners:
        ...
        for corner in remainingCorners:
            distanceList.append((util.manhattanDistance(currentPos, corner), corner))

        # find min distance and add to heuristic
        minDistance, corner = min(distanceList)
        heuristic += minDistance

        # remove visted corner
        currentPos = corner
